# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2017-08-28 17:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_answer', crowdsourcing.fields.ImageWithThumbnailsField(blank=True, max_length=500, upload_to=b'crowdsourcing/images/%Y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(help_text=b'What order does this question appear in the survey form and in permalinks?')),
                ('option_type', models.CharField(choices=crowdsourcing.util.ChoiceEnum([(b'bool', b'Checkbox'), (b'bool_list', b'Checkbox List'), (b'date', b'Date Box'), (b'float', b'Decimal Text Box'), (b'select', b'Drop Down List'), (b'email', b'Email Text Box'), (b'integer', b'Integer Text Box'), (b'location', b'Location Text Box'), (b'numeric_select', b'Numeric Drop Down List'), (b'numeric_choice', b'Numeric Radio Button List'), (b'photo', b'Photo Upload'), (b'choice', b'Radio Button List'), (b'ranked', b'Ranked List'), (b'text', b'Text Area'), (b'char', b'Text Box'), (b'video', b'Video Link Text Box')]), help_text='You must not change this field on a live survey.', max_length=14)),
                ('numeric_is_int', models.BooleanField(default=True, editable=False)),
                ('options', models.TextField(blank=True, default=b'', help_text='Use one option per line. On a live survey you can modify the order of these options. You can, at your own risk, add new options, but you must not change or remove options.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('thanks', models.TextField(blank=True, help_text=b'When a user submits the survey, display this message.')),
                ...
                ('allow_comments', models.BooleanField(default=False, help_text=b'Allow comments on user submissions.')),
                ('allow_voting', models.BooleanField(default=False, help_text=b'Users can vote on submissions.')),
                ('archive_policy', models.IntegerField(choices=crowdsourcing.util.ChoiceEnum([(1, b'immediate'), (2, b'post-close'), (3, b'never')]), default=1, help_text='At what point will Crowdsourcing make the results public? immediate: All results are immediately public. post-close: Results are public on or after the "ends at" option documented below. never: Results are never public.')),
                ...
                ('has_script', models.BooleanField(default=False, help_text=b'If enabled, template will render script tag for STATIC_URL/surveys/slug-name.js')),
                ('is_published', models.BooleanField(default=False)),
                ('email', models.CharField(blank=True, help_text=b'Send a notification to these e-mail addresses whenever someone submits an entry to this survey. Comma delimited.', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_by_rating', models.BooleanField(default=False, help_text=b'By default, sort descending by highest rating. Otherwise, the default sort is by date descending.')),
                ('display_the_filters', models.BooleanField(default=True, help_text=b'Display the filters at the top of the report page.')),
                ('limit_results_to', models.PositiveIntegerField(blank=True, help_text=b'Only use the top X submissions.', null=True)),
        ...
        migrations.AddField(
            model_name='survey',
            name='default_report',
            field=models.ForeignKey(blank=True, help_text=b"Whenever we automatically generate a link to the results of this survey we'll use this report. If it's left blank, we'll use the default report behavior.", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='crowdsourcing.SurveyReport'),
        ),
        migrations.AddField(
            model_name='survey',
            name='sections',
