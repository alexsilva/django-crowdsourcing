...
FLICKR_API_KEY = getattr(settings, 'CROWDSOURCING_FLICKR_API_KEY', '')

FLICKR_API_SECRET = getattr(settings, 'CROWDSOURCING_FLICKR_API_SECRET', '')
...
FLICKR_TOKEN = getattr(settings, 'CROWDSOURCING_FLICKR_TOKEN', '')

FLICKR_FROB = getattr(settings, 'CROWDSOURCING_FLICKR_FROB', '')

""" Are Flickr photos live by default? """
FLICKR_LIVE = getattr(settings, 'CROWDSOURCING_FLICKR_LIVE', False)

FLICKR_TOKENCACHE_PATH = getattr(settings,
